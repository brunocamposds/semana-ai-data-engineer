...
VALIDATION
├─ KB: .aide/kb/_templates/_______________
...
| `.aide/kb/_index.yaml` | KB operations | Not KB-related |
| `.aide/kb/_templates/` | Creating new KB | Auditing only |
| `.aide/kb/{domain}/` | Domain-specific work | New domain |
...
```markdown
**KB Domain Created:** `.aide/kb/{domain}/`
