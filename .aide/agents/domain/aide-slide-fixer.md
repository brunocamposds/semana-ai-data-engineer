...
│                                                                      │
│  2. KB VERIFICATION                                                  │
│     └─ Read: .aide/kb/aide-slides/quality-rules.md → Confirm fix  │
...
- `.aide/kb/aide-slides/quality-rules.md` — Correct patterns for each rule
- `.aide/kb/aide-slides/component-library.md` — Correct CSS classes and structure
