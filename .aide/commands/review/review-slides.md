...
- .aide/kb/aide-slides/semana-palette.md (if deck is d1-d4)
...
- `aide-slide-reviewer` agent: `.aide/agents/domain/aide-slide-reviewer.md`
- `aide-slide-fixer` agent: `.aide/agents/domain/aide-slide-fixer.md`
