...
1. **Validates prerequisites** — checks `.aide/kb/_templates/` exist
...
- Scan all directories under `.aide/kb/`
...
Created:
  .aide/kb/<domain>/index.md
  .aide/kb/<domain>/quick-reference.md
  .aide/kb/<domain>/concepts/<concept-1>.md
  .aide/kb/<domain>/concepts/<concept-2>.md
  .aide/kb/<domain>/patterns/<pattern-1>.md
```
...
| Templates missing | Error with: "Run from repo root. Check .aide/kb/_templates/ exists" |
...
- **Agent**: `.aide/agents/exploration/kb-architect.md`
- **Example KB**: `.aide/kb/pydantic/` (well-structured reference)
- **Templates**: `.aide/kb/_templates/`
