...
Analyzes codebase and intelligently updates `.aide/CLAUDE.md` with current project context.
...
git diff .aide/CLAUDE.md

# Commit with context
git add .aide/CLAUDE.md
