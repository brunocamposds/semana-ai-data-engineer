...
Read these KB files:
- .aide/kb/aide-slides/quality-rules.md
- .aide/kb/aide-slides/slide-types.md
- .aide/kb/aide-slides/advanced-visuals.md
- .aide/kb/aide-slides/{palette_file}
...
- SVG slides → .aide/kb/aide-slides/advanced-visuals.md
- Card/stat slides → .aide/kb/aide-slides/component-library.md
- All chunks → .aide/kb/aide-slides/quality-rules.md
- All chunks → .aide/kb/aide-slides/{palette_file}
- Chunk 1 only → .aide/kb/aide-slides/template.md (for <head> and structure)
- Chunk 1 only → .aide/kb/aide-slides/slide-engine.md (for JS)
...
Read KB files:
- .aide/kb/aide-slides/quality-rules.md
- .aide/kb/aide-slides/component-library.md
- .aide/kb/aide-slides/design-system.md
- .aide/kb/aide-slides/{palette_file}
...
- Quality rules KB: `.aide/kb/aide-slides/quality-rules.md`
