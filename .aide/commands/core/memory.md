...
Save session insights to `.aide/storage/` for future reference.
...
3. **Saves** to `.aide/storage/memory-{YYYY-MM-DD}.md`
...
Creates: `.aide/storage/memory-{YYYY-MM-DD}.md`
...
3. Write to storage:
   - Create .aide/storage/ if not exists
...
Saved to: .aide/storage/memory-2026-01-23.md
